...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
<!--a href="#" id='add_row'>Add More Row</a-->
<table class="sum">
    <tr>
...
<script>
    ...
    $("#add_row").on("click", function () { 
        var newRow = $("<tr>");
        var cols = "";
        cols += '<td>Remove Another Row</td>';
        cols += '<td><input type="text" value="" class="price" /><br></td>';
        cols += '<td><a href="#">remove</a></td>';
        newRow.append(cols);
       /* if (counter == 4) $('#addrow').attr('disabled', true).prop('value', "You've reached the limit");*/
        $("table.sum").append(newRow);
    });
    $('.sum').each(function(){
        var total = 0;
